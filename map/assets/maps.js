    ...
    t(function() {
        t('script[type="widgetkit/map"]').each(function() {
            ...
            i.replaceWith(r), o().then(function() {
                ...
                }, i = new google.maps.Map(r[0], o), p.length && s.directions && (a = t('<a target="_blank"></a>').css({
                    padding: "5px 1px",
...
//console.log(s.zoom);
                  ...
                  //var mi = empty(s.svg, 10);
              console.log(s.svg);
                  var image = new google.maps.MarkerImage(s.svg,
                ...
                var u = new google.maps.StyledMapType([{
                    featureType: "all",
                    elementType: "all",
                    stylers: [{
                ...
                i.mapTypes.set("styled_map", u), "ROADMAP" == s.maptypeid.toUpperCase() && i.setMapTypeId("styled_map")
            })
        })
    }), e.prototype.MARKER_CLUSTER_IMAGE_PATH_ = "https://yastatic.net/www/_/Q/4/_r83i4F4aOiWg6UfNBwf-x-zM.svg", e.prototype.MARKER_CLUSTER_IMAGE_EXTENSION_ = "svg", e.prototype.extend = function(t, e) {
        return function(t) {
